...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 14, 2024 at 12:47 AM
...
INSERT INTO `excuse_letter` (`id`, `excuse_letter`, `comment`, `date_submitted`, `date_absent`, `subject_id`, `student_id`, `reason_id`) VALUES
(18, 0x433a5c78616d70705c6874646f63735c70726f6a6563745c73747564656e742d766965772f75706c6f6164732f73637265656e73686f743033342e6a7067, 'ddddd', '2024-12-12', '2024-11-01', 1, 3, 1),
(34, 0x73637265656e73686f743030332e6a7067, 'sdsds', '2024-11-30', '2024-11-08', 1, 3, 1),
(35, 0x73637265656e73686f743030352e6a7067, 'rfdred', '2024-12-02', '2024-12-11', 1, 3, 2),
(36, 0x73637265656e73686f743030332e6a7067, 'wesdfwe', '2024-12-04', '2024-11-15', 1, 3, 1),
(45, 0x73637265656e73686f743030342e6a7067, 'weew', '2024-12-11', '2024-11-15', 1, 3, 2),
(46, 0x73637265656e73686f743032372e6a7067, 'wewe', '2024-12-11', '2024-12-06', 1, 3, 2),
(47, 0x73637265656e73686f743030342e6a7067, 'iioyui', '2024-12-11', '2024-12-06', 3, 1, 1),
(48, 0x73637265656e73686f743033302e6a7067, 'werdwe', '2024-12-12', '2024-12-06', 2, 4, 2),
(52, 0x73637265656e73686f743030392e6a7067, 'wqqqw', '2024-12-12', '2024-12-07', 1, 3, 1),
(53, 0x73637265656e73686f743030352e6a7067, 'sdsd', '2024-12-13', '2024-12-05', 1, 3, 1),
(54, 0x73637265656e73686f743030352e6a7067, 'sdsd', '2024-12-13', '2024-12-05', 1, 3, 1),
(55, 0x73637265656e73686f743032342e6a7067, 'gfthgfh', '2024-12-13', '2024-12-06', 3, 3, 2),
(56, 0x73637265656e73686f743031312e6a7067, 'fds', '2024-12-13', '2024-12-05', 3, 3, 2);
...
--
-- Table structure for table `prof_approval`
--

CREATE TABLE `prof_approval` (
  `id` int(11) NOT NULL,
  `excuse_letter_id` int(11) NOT NULL,
...
--
-- Dumping data for table `prof_approval`
--

INSERT INTO `prof_approval` (`id`, `excuse_letter_id`, `prof_id`, `prof_awknowledge`) VALUES
(3, 18, 4, NULL),
(4, 34, 4, NULL),
(5, 35, 4, NULL),
(6, 36, 1, NULL),
...
--
-- Indexes for table `prof_approval`
--
ALTER TABLE `prof_approval`
  ADD PRIMARY KEY (`id`),
  ADD KEY `excuse_letter_id` (`excuse_letter_id`),
...
--
-- AUTO_INCREMENT for table `prof_approval`
--
ALTER TABLE `prof_approval`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
-- Constraints for table `prof_approval`
--
ALTER TABLE `prof_approval`
  ADD CONSTRAINT `prof_approval_ibfk_1` FOREIGN KEY (`excuse_letter_id`) REFERENCES `excuse_letter` (`id`),
  ADD CONSTRAINT `prof_approval_ibfk_2` FOREIGN KEY (`prof_id`) REFERENCES `professors` (`ID`);
